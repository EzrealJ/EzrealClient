...
using EzrealClient;
using EzrealClient.Extensions.OAuths;
using EzrealClient.Extensions.OAuths.TokenProviders;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class TokenProviderExtensions
    {
        ...
        /// <returns></returns>
        public static ITokenProviderBuilder AddTokenProvider<THttpApi>(this IServiceCollection services, Func<IServiceProvider, System.Threading.Tasks.Task<TokenResult?>> tokenRequest)
        {
