...
namespace EzrealClient.Analyzers
{
    ...
    {
        private const string IHttpApiTypeName = "EzrealClient.IHttpApi";
        private const string IApiAttributeTypeName = "EzrealClient.IApiAttribute";
        private const string UriAttributeTypeName = "EzrealClient.Attributes.UriAttribute";
        private const string AttributeCtorUsageTypName = "EzrealClient.AttributeCtorUsageAttribute";
